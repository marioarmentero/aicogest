...
using aicoffi.Droid.Utils;

namespace aicoffi.Droid.Renderer
{
        ...
        public class BottomBarPageRenderer : VisualElementRenderer<BottomBarPage>, IOnTabClickListener
		{
			...
			protected override void OnElementChanged(ElementChangedEventArgs<BottomBarPage> e)
			{
				...
				if (e.NewElement != null)
				{
					...
					if (_bottomBar == null)
					{
						_pageController = (Utils.IPageController)PageController.Create(bottomBarPage);
            ...
            void SetTabItems()
			{
				BottomBarTab[] tabs = Element.Children.Select(page => {
					var tabIconId = ResourceManagerEx.IdFromTitle(page.Icon, System.Resources.ResourceManager..DrawableClass);
					return new BottomBarTab((int)tabIconId, page.Title);
				}).ToArray();
